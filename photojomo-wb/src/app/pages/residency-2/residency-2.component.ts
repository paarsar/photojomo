...
@Component({
  selector: 'app-residency-2',
  standalone: true,
  imports: [CommonModule, RouterLink, NavbarComponent],
  templateUrl: './residency-2.component.html',
  styleUrls: ['./residency-2.component.css'],
})
export class Residency2Component {
  openProgramDetailIndex = 0;

  readonly programDetails: ProgramDetail[] = [
    {
  ...
  toggleProgramDetail(index: number): void {
    this.openProgramDetailIndex = this.openProgramDetailIndex === index ? -1 : index;
  }
}
